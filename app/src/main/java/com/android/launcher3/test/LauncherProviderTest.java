...
/**
 * 熟悉继承 ContentProvider 实现的方法
 * 纯粹测试
 * 必须重写方法
 * onCreate、query、getType、insert、delete、update
 */
public class LauncherProviderTest extends ContentProvider {
    /**
     ...
     *
     * @return 如果提供程序已成功加载，则为true，否则为false
     */
    @Override
    ...
    /**
     * 重写此操作以处理插入一组新行的请求，或*默认实现将迭代值并在每个值上调用* {@link #insert}。
     * @param uri
     * @param values
     * @return
     */
